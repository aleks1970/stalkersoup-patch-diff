...
float3 blurred=c_original;
blurred+=tex2Dlod(s_image,float4(p_velocity*1.h+UV,0,0)).rgb;
blurred+=tex2Dlod(s_image,float4(p_velocity*2.h+UV,0,0)).rgb;
blurred+=tex2Dlod(s_image,float4(p_velocity*3.h+UV,0,0)).rgb;
blurred+=tex2Dlod(s_image,float4(p_velocity*4.h+UV,0,0)).rgb;
blurred+=tex2Dlod(s_image,float4(p_velocity*5.h+UV,0,0)).rgb;
blurred+=tex2Dlod(s_image,float4(p_velocity*6.h+UV,0,0)).rgb;
blurred+=tex2Dlod(s_image,float4(p_velocity*7.h+UV,0,0)).rgb;
blurred+=tex2Dlod(s_image,float4(p_velocity*8.h+UV,0,0)).rgb;
blurred+=tex2Dlod(s_image,float4(p_velocity*9.h+UV,0,0)).rgb;
blurred+=tex2Dlod(s_image,float4(p_velocity*10.h+UV,0,0)).rgb;
blurred+=tex2Dlod(s_image,float4(p_velocity*11.h+UV,0,0)).rgb;
return blurred/12;
}
#endif
#endif
